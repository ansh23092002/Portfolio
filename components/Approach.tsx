...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4  lg:h-[30rem] rounded-3xl"
    >
...
const AceternityIcon = ({order}: {order:string}) => {
  ...
  <span className="inline-flex h-full text-2xl w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-2  font-bold  text-white backdrop-blur-3xl">
   {order}
  </span>
</button>
